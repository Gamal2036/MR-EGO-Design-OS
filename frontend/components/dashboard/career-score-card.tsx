...
interface CareerScoreCardProps extends HTMLAttributes<HTMLDivElement> {
  score: number;
  label?: string;
  description?: string;
}
      ...
      >
        ...
        <CardContent>
          <div className="flex flex-col items-center gap-3">
            <div className="relative flex items-center justify-center" role="img" aria-label={`Career score: ${score} out of 100`}>
              <svg
                width="128"
                height="128"
                viewBox="0 0 128 128"
...
export type { CareerScoreCardProps };
