...
export interface CoachErrorStateProps extends HTMLAttributes<HTMLDivElement> {
  onRetry?: () => void;
}

const CoachErrorState = forwardRef<HTMLDivElement, CoachErrorStateProps>(
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <h2 className="text-heading-3 text-primary font-semibold">
                Could not load coach
              </h2>
              <p className="text-body-small text-secondary">
                Something went wrong while preparing your coaching session. Please try again.
              </p>
            </div>
            {onRetry && (
...
CoachErrorState.displayName = "CoachErrorState";

export { CoachErrorState };
